...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_EM5340_V1, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_HFXO_CAP_INTERNAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_HFXO_CAP_INT_VALUE_X2, 22);
